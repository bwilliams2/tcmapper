...
static PyObject *__pyx_f_13calc_distance_GeodesicInverse(double, double, double, double); /*proto*/
...
static const char __pyx_k_geocalc_calc_distance_pyx[] = "geocalc/calc_distance.pyx";
...
static PyObject *__pyx_kp_s_geocalc_calc_distance_pyx;
...
static PyObject *__pyx_f_13calc_distance_GeodesicInverse(double __pyx_v_lat1, double __pyx_v_lon1, double __pyx_v_lat2, double __pyx_v_lon2) {
  double __pyx_v_s12;
  double __pyx_v_azi1;
  double __pyx_v_azi2;
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_s12); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("calc_distance.GeodesicInverse", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_13calc_distance_1FindDistances(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("FindDistances (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lat1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("FindDistances", 1, 3, 3, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lon1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FindDistances", 1, 3, 3, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "FindDistances") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_locs = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_locs.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_lat1 = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_lat1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_lon1 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_lon1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("FindDistances", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_locs.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_distances_arr, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 13, __pyx_L1_error)
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_locs.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_locs.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_locs.shape[1];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_locs.shape[1])) __pyx_t_12 = 1;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 17, __pyx_L1_error)
    }
    __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_locs.data + __pyx_t_10 * __pyx_v_locs.strides[0]) ) + __pyx_t_11 * __pyx_v_locs.strides[1]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_lat2, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "calc_distance.pyx":18
 *     for i in range(locs.shape[0]):
 *         lat2 = locs[i, 0]
 *         lon2 = locs[i, 1]             # <<<<<<<<<<<<<<
 *         distances[i] = GeodesicInverse(lat1, lon1, lat2, lon2)
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_locs.shape[0];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_locs.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_locs.shape[1];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_locs.shape[1])) __pyx_t_12 = 1;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 18, __pyx_L1_error)
    }
    __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_locs.data + __pyx_t_13 * __pyx_v_locs.strides[0]) ) + __pyx_t_14 * __pyx_v_locs.strides[1]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 18, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_XDECREF_SET(__pyx_v_lon2, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "calc_distance.pyx":19
 *         lat2 = locs[i, 0]
 *         lon2 = locs[i, 1]
 *         distances[i] = GeodesicInverse(lat1, lon1, lat2, lon2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_15 = __pyx_PyFloat_AsDouble(__pyx_v_lat2); if (unlikely((__pyx_t_15 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
    __pyx_t_16 = __pyx_PyFloat_AsDouble(__pyx_v_lon2); if (unlikely((__pyx_t_16 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
    __pyx_t_5 = __pyx_f_13calc_distance_GeodesicInverse(__pyx_v_lat1, __pyx_v_lon1, __pyx_t_15, __pyx_t_16); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_16 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_16 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_17 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_distances.shape[0];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_distances.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 19, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_distances.data + __pyx_t_17 * __pyx_v_distances.strides[0]) )) = __pyx_t_16;
  }

  /* "calc_distance.pyx":21
 *         distances[i] = GeodesicInverse(lat1, lon1, lat2, lon2)
 * 
 *     return distances_arr             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_geocalc_calc_distance_pyx, __pyx_k_geocalc_calc_distance_pyx, sizeof(__pyx_k_geocalc_calc_distance_pyx), 0, 0, 1, 0},
 ...
 *     cdef double[:] distances = distances_arr
 */
  __pyx_tuple__19 = PyTuple_Pack(8, __pyx_n_s_locs, __pyx_n_s_lat1, __pyx_n_s_lon1, __pyx_n_s_distances_arr, __pyx_n_s_distances, __pyx_n_s_i, __pyx_n_s_lat2, __pyx_n_s_lon2); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_geocalc_calc_distance_pyx, __pyx_n_s_FindDistances, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     cdef double[:] distances = distances_arr
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13calc_distance_1FindDistances, NULL, __pyx_n_s_calc_distance); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_FindDistances, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
