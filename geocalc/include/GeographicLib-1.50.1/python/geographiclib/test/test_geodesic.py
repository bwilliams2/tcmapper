...
class PlanimeterTest(unittest.TestCase):
    ...
    def test_Planimeter15(self):
        ...
        num, perimeter, area = PlanimeterTest.polygon.TestPoint(
            lat[2], lon[2], False, True
        )
        self.assertAlmostEqual(area, r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestPoint(
            lat[2], lon[2], False, False
        )
        self.assertAlmostEqual(area, r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestPoint(
            lat[2], lon[2], True, True
        )
        self.assertAlmostEqual(area, -r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestPoint(
            lat[2], lon[2], True, False
        )
        self.assertAlmostEqual(area, a0 - r, delta=0.5)
        inv = Geodesic.WGS84.Inverse(lat[1], lon[1], lat[2], lon[2])
        azi1 = inv["azi1"]
        s12 = inv["s12"]
        num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi1, s12, False, True)
        self.assertAlmostEqual(area, r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi1, s12, False, False)
        self.assertAlmostEqual(area, r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi1, s12, True, True)
        self.assertAlmostEqual(area, -r, delta=0.5)
        num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi1, s12, True, False)
        self.assertAlmostEqual(area, a0 - r, delta=0.5)
    ...
    def test_Planimeter19(self):
        ...
        num, perimeter, area = PlanimeterTest.polygon.TestPoint(1, 1, False, True)
        self.assertTrue(area == 0)
        self.assertTrue(perimeter == 0)
        num, perimeter, area = PlanimeterTest.polygon.TestEdge(90, 1000, False, True)
        self.assertTrue(Math.isnan(area))
        ...
        self.assertTrue(perimeter == 0)
        num, perimeter, area = PlanimeterTest.polyline.TestPoint(1, 1, False, True)
        self.assertTrue(perimeter == 0)
        num, perimeter, area = PlanimeterTest.polyline.TestEdge(90, 1000, False, True)
        self.assertTrue(Math.isnan(perimeter))
        ...
        num, perimeter, area = PlanimeterTest.polyline.TestPoint(2, 2, False, True)
    ...
    def test_Planimeter21(self):
        ...
        for i in [3, 4]:
            ...
            num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi, s, False, True)
            self.assertAlmostEqual(area, i * r, delta=0.5)
            num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi, s, False, False)
            self.assertAlmostEqual(area, i * r, delta=0.5)
            num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi, s, True, True)
            self.assertAlmostEqual(area, -i * r, delta=0.5)
            num, perimeter, area = PlanimeterTest.polygon.TestEdge(azi, s, True, False)
            self.assertAlmostEqual(area, -i * r + a0, delta=0.5)
            PlanimeterTest.polygon.AddPoint(lat, -60)
            num, perimeter, area = PlanimeterTest.polygon.Compute(False, True)
            self.assertAlmostEqual(area, i * r, delta=0.5)
