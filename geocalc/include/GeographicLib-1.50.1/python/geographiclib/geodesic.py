    ...
    *f*) is not a finite positive quantity.
    ...
    def _Lengths(
        ...
        if outmask & Geodesic.DISTANCE:
            ...
            J12 = m0x * sig12 + (
                Geodesic._SinCosSeries(True, ssig2, csig2, C2a)
                - Geodesic._SinCosSeries(True, ssig1, csig1, C2a)
            )
    ...
    def _Lambda12(
        ...
        eps = k2 / (2 * (1 + math.sqrt(1 + k2)) + k2)
        self._C3f(eps, C3a)
        B312 = Geodesic._SinCosSeries(True, ssig2, csig2, C3a) - Geodesic._SinCosSeries(
