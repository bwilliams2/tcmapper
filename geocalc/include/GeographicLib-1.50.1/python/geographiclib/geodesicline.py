...
class GeodesicLine(object):
    ...
    *salp1* and *calp1* should not be supplied; they are part of the
    ...
    """
        ...
        # real cbet1, sbet1
        sbet1, cbet1 = Math.sincosd(Math.AngRound(self.lat1))
        sbet1 *= self._f1
    ...
    def _GenPosition(self, arcmode, s12_a12, outmask):
        ...
        if outmask & Geodesic.LONGITUDE:
            ...
            lam12 = omg12 + self._A3c * (
                sig12
                + (Geodesic._SinCosSeries(True, ssig2, csig2, self._C3a) - self._B31)
            )
    ...
    *lon1*, *azi1*, *lat2*, *lon2*, *azi2*, *s12*, *a12* entries are
    ...
    """
        ...
        self.a13 = a13
        _, _, _, _, self.s13, _, _, _, _ = self._GenPosition(
            True, self.a13, Geodesic.DISTANCE
        )
