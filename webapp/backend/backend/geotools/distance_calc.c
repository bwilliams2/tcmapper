...
static PyObject *__pyx_pf_13distance_calc_get_distances(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_fname, double __pyx_v_baseLong, double __pyx_v_baseLat, int __pyx_v_searchRadius, int __pyx_v_recordLength) {
  ...
  __Pyx_RefNannySetupContext("get_distances", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_13distance_calc_get_distances(__pyx_v_fname, __pyx_v_baseLong, __pyx_v_baseLat, __pyx_v_searchRadius, __pyx_v_recordLength, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
